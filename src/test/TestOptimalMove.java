...
public class TestOptimalMove {
    ...
    public void testMateInOne() {
        Board board = new BoardBuilder()
                ...
                .blackToMove()
                .build();
        Move optimalMove = AlphaBeta.findOptimalMove(board, 3).getSecond();
    ...
    public void testCaptureInOneWithChoice() {
        Board board = new BoardBuilder()
                ...
                .build();
        Move optimalMove = AlphaBeta.findOptimalMove(board, 4).getSecond();
        assertThat(optimalMove.toString())
                .isEqualTo(
                        new DefaultMove(
                                board.getPieceAt(4, 1),
...
//                .build();
//        Move optimalMove = Minimax.findOptimalMove(board, 5).getSecond();
//        assertThat(optimalMove.toString())
//                .isEqualTo(
//                        new DefaultMove(
